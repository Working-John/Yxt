# lxm-search-toptab 是uniapp项目通用前端页面框架之一，原生顶部导航栏带搜索框背景透明+上部可拖动选项卡导航+底部导航+上部宣传轮播图+图文列表+详情页面+下拉刷新+上拉加载更多。一般是用来做首页模板。
> **模板名：lxm-search-toptab ，版本：1.0.0**


首页框架模板：原生顶部带搜索框导航连带上部选项卡导航底部导航。

> **注意事项**
> 为了避免错误使用，给大家带来不好的开发体验，请在使用模板前仔细阅读下面的注意事项，可以帮你避免一些错误。


### 安装方式

1.本组件符合[easycom](https://uniapp.dcloud.io/collocation/pages?id=easycom)规范，`HBuilderX 3.1.0`起，只需将本组件以uni_modules方式导入项目，在页面`template`中即可直接使用，无需在页面中`import`和注册`components`。或者在直接导入项目示例工程。
2.uniapp主框架已经搭好，根据需要自己补充修改增加删减内容和事件逻辑。
...
//在 ``pages.json`` 中参考模板重新修改配置路由等
{
	"pages": [ //pages数组中第一项表示应用启动页，参考：https://uniapp.dcloud.io/collocation/pages
		...
		{
			"path": "pages/index/detail1/detail1",
			"style": {
	...
	"tabBar": {
		...
		"list": [{
			...
			},
			{
				...
				"text": "测试",
				"iconPath": "static/search_default.png",
...
lxm-search-toptab传奇开心果模板V1.0.0，传奇开心果制作。
