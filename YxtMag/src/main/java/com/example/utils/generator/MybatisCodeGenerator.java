...
public class MybatisCodeGenerator {
    ...
    private static final String schemaName = "yanxuetong";   // 数据库名称，必填
    private static final String[][] tables = {{"tea_stu", "teastu"}};   // 必填
    private static final String modelName = "导师学生";   // 必填

    static {
        // 必填
        ds.setUrl("jdbc:mysql://47.97.153.205:3306/" + schemaName + "?useUnicode=true&characterEncoding=utf-8&allowMultiQueries=true&useSSL=false&serverTimezone=GMT%2b8");
        ds.setUsername("root");
        ds.setPassword("Yxt@123-");
    }
